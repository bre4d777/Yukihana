...
class PrefixCommand extends Command {
  ...
  async execute({ message, args, prefix }) {
    if (args.length === 0) {
      const embed = new EmbedBuilder()
        ...
        .addFields(
          {
            name: "Usage",
            value: `To change it: \`${prefix}prefix <new prefix>\``,
          },

          {
            name: "Default Prefix",
            value: `The default prefix is: \`${config.prefix}\``,
          }
        )
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields({
        name: "Example",
        value: `Use commands with: \`${newPrefix}help\``,
      })
    ...
    if (!newPrefix) {
      const embed = new EmbedBuilder()
        ...
        .addFields(
          {
            name: "Usage",
            value: `To change it: \`/prefix newprefix:<new prefix>\``,
          },
          {
            name: "Default Prefix",
            value: `The default prefix is: \`${config.prefix}\``,

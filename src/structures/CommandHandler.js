...
export class CommandHandler {
  ...
  async loadCommands(dirPath = '../commands') {
    ...
    try {
      ...
      logger.success('CommandHandler', `Loaded ${this.commands.size} prefix and ${this.slashCommandFiles.size} slash commands.`);
    } catch (error) {
  ...
  async reloadAllCommands() {
    ...
    try {
      ...
      return { success: true, message: `Reloaded ${this.commands.size} prefix and ${this.slashCommandFiles.size} slash commands.` };
    } catch (error) {
